...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-splitwise text-start text-base font-medium text-splitwise bg-splitwise/10 focus:outline-none focus:text-white focus:bg-splitwise/15 focus:border-emerald-200 transition duration-150 ease-in-out'
